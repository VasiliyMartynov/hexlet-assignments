...
public class UsersServlet extends HttpServlet {
    ...
    private void createUser(HttpServletRequest request,
        ...
        if (newUserFirstName.isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/new.jsp");
            request.setAttribute("firstName", newUserFirstName);
        ...
        if (newUserLastName.isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/new.jsp");
            request.setAttribute("lastName", newUserFirstName);
            request.setAttribute("error", "Фамилия не может быть пустой");
            response.setStatus(422);
            requestDispatcher.forward(request, response);
            return;
        }
        ...
        newUser.put("firstName", newUserFirstName);
        newUser.put("lastName", newUserLastName);
        newUser.put("email", newUserEmail);
        users.add(newUser);
    ...
    private void updateUser(HttpServletRequest request,
        ...
        user.replace("firstName", newUserFirstName);
        user.replace("lastName", newUserLastName);
        user.replace("email", newUserEmail);
        request.setAttribute("user", user);
